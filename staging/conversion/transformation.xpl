...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:pwl="http://papyri.uni-koeln.de/papyri-woerterlisten" version="1.0" type="pwl:transform" name="wl-input-subpipeline">
    ...
    <p:xslt name="merge-files">
        <p:input port="stylesheet">
            <p:document href="1-merge-files.xsl"/>
        </p:input>
    </p:xslt>
    ...
    <p:xslt name="create-generic-structure">
        <p:input port="stylesheet">
            <p:document href="2-create-generic-structure.xsl"/>
        </p:input>
    </p:xslt>
    ...
    <p:xslt name="build-up-TEI">
        ...
        <p:input port="stylesheet">
            <p:document href="3-build-up-TEI.xsl"/>
        </p:input>
    </p:xslt>
    ...
    <p:xslt name="gather-by-language">
        <p:input port="stylesheet">
            <p:document href="4-gather-by-language.xsl"/>
        </p:input>
    </p:xslt>
    ...
    <p:xslt name="assign-new-IDs">
        <p:input port="stylesheet">
            <p:document href="5-assign-new-IDs.xsl"/>
        </p:input>
    </p:xslt>
    ...
    <p:xslt name="build-teiHeader">
        ...
        <p:with-param name="comparisonBase" select="$comparisonBase"/>
        <p:input port="stylesheet">
            <p:document href="6-build-teiHeader.xsl"/>
        </p:input>
    </p:xslt>
